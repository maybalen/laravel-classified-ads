...
class StateController extends Controller
{
    ...
    public function update(StoreStateRequest $request, State $state)
    {
        ...
        return redirect()->route('admin.states.index')->with('message', 'State has  been updated Successfully');
    }
    ...
    {
        $state->delete();
        return redirect()->route('admin.states.index')->with('message', 'State has been deleted Successfully');
    }
}
