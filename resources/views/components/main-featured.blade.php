<section class="text-gray-600 body-font">
    <div class="container px-5 py-24 mx-auto">
      ...
      <a href="{{ route('listings.index') }}" class="flex mx-auto mt-16 text-white bg-red-500 border-0 py-2 px-8 focus:outline-none hover:bg-red-600 rounded text-lg">All Listing</a>
    </div>
  </section>