          ...
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              ...
              <tr>
                <td class="px-6 py-4 whitespace-nowrap">
                  <div class="flex items-center">
                    <div class="flex-shrink-0 h-10 w-10">
                      <img class="h-10 w-10 rounded-md" src="{{ Storage::url($sub_category->image) }}" alt="" />
                    </div>
                  </div>
                </td>
                <td class="px-6 py-4 whitespace-nowrap">
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                    <div class="text-sm text-gray-900">{{ $sub_category->slug }}</div>
                </td>  
                <td class="px-6 py-4 whitespace-nowrap">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                  <div class="flex">
                    <a href="{{ route('admin.subcategories.edit', $sub_category->id) }}" class="flex m-auto text-white bg-blue-500 border-0 py-2 px-5 focus:outline-none hover:bg-blue-600 rounded">Edit</a>

                    <form action="{{ route('admin.subcategories.destroy', $sub_category->id) }}" method="POST">
                    @csrf
                    @method('DELETE')
              ...
              <tr>
                <td>
                  <div class="m-2 p-2">No Any Sub Category</div>
                </td>
              </tr>
