...
@if (!is_null($selectedSubCategory))
        <div class="mt-1 flex rounded-md shadow-sm">
          <select wire:model="selectedChildCategory" name="child_category_id" id="child_category_id" class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300">
                <option value="">--selecting--</option>
